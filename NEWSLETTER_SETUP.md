...
4. Special characters in passwords must be URL-encoded (e.g., use `encodeURIComponent('my@pass#word')` in JavaScript, or use online tools like https://www.urlencoder.org)
