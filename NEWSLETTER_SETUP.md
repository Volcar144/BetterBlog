...
4. Special characters in passwords must be URL-encoded (e.g., `my@pass#word` becomes `my%40pass%23word` - use `encodeURIComponent()` in JavaScript or https://www.urlencoder.org)
